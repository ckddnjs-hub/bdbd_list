      ...
      <div style={{width:'100%',maxWidth:440}}>
        ...
        <div style={{marginTop:13,background:'rgba(0,0,0,0.3)',borderRadius:14,padding:16,backdropFilter:'blur(8px)'}}>
          ...
          {[            {icon:'👨‍🏫',title:'배경스토리',items:[
              ...
              '곧 국장이 참석하는 하반기 퍼포먼스 리뷰(인사 고과 평가)가 시작됩니다. ',
              '당신은 팀장으로서 뒤죽박죽 쌓여있는 업무 스케줄(손패)을 정리해 가장 돋보이는 성과를 보고해야 합니다.',
              '업무 일정은 이미 픽스되어 함부로 순서를 바꿀 수 없습니다.',

              '상대 팀이 엄청난 성과를 발표해 기가 죽었다고요?',
              '그렇다면 남의 보고서에서 핵심 자료를 교묘하게 [인용]해서 내 발표 빈틈을 메우세요.',
              '단, 아이디어를 제공한 상대 팀에게는 소정의 기여도(점수)를 인정해 주어야 합니다. ',
              '가장 먼저 모든 업무를 털어내고 완벽한 성과를 증명하는 자만이 발탁승진할 수 있습니다!.',
            ]},
